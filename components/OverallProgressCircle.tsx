        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          {simplified ? (
            ...
            <>
              ...
              <div className="text-white text-5xl font-bold mb-3.5">{percentage}%</div>
              <div className="text-zinc-400 text-xs text-center leading-tight font-medium tracking-wider mb-3.5">
