...
CREATE TABLE IF NOT EXISTS public.momentum_gains (
  ...
  gain_amount DECIMAL(5,2) NOT NULL,
...
CREATE INDEX IF NOT EXISTS code_completions_user_code_idx ON public.code_completions(user_id, code_id, completed_at DESC);
