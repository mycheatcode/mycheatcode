...
This is a simplified, principle-based prompt (224 lines) that replaces the rigid, procedural v6 prompt (3400+ lines).

**Key Changes:**
- Removes all "pre-flight checklists" and rigid verification steps
- Focuses on coaching principles rather than step-by-step procedures
- Gives the AI freedom to adapt to each unique conversation
- Keeps ALL cheat code formatting rules intact (so buttons still work)
- Encourages depth and authentic conversation over formulaic exchanges
