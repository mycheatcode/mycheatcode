        ...
        <div className="px-4 pb-4 space-y-3">
          {getFilteredTopics().map((topic) => (
            <div
              ...
              className="relative p-5 rounded-2xl border transition-all cursor-pointer border-zinc-800 bg-zinc-950 hover:border-zinc-700 active:scale-98 hover:scale-[1.02]"
            >
              {topic.trending && (
          ...
          <div className="grid grid-cols-1 gap-6">
            {getFilteredTopics().map((topic) => (
              <div
                key={topic.id}
                onClick={() => handleTopicSelect(topic)}
                className="relative p-6 rounded-2xl border transition-all cursor-pointer border-zinc-800 bg-zinc-950 hover:border-zinc-700 hover:scale-[1.02]"
              >
                {topic.trending && (
