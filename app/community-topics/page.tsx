...
export default function CommunityTopics() {
  ...
  const topics = [
    ...
    },
    {
      ...
      trending: "NEW",
      category: "Post-Game",
      customStarter: "Great topic choice, this is something that's very common!  What kind of mistakes do you replay in your mind? I'll help you grow from them instead of letting them keep you down."
    },
    {
      id: 6,
        ...
        <div className={`absolute top-0 left-0 h-full w-80 bg-zinc-950 border-r border-zinc-800 flex flex-col transform transition-transform duration-300 z-10 ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <nav className="flex-1">
            <div>
              ...
              <Link href="/community-topics" className="flex items-center gap-3 p-4 text-white bg-zinc-900/50 font-medium cursor-pointer transition-colors relative">
