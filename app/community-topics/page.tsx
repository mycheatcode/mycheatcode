        ...
        <div className="px-4 pb-4 space-y-3">
          {getFilteredTopics().map((topic) => (
            <div
              ...
              className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5 transition-all duration-500 cursor-pointer active:scale-98 hover:scale-[1.02] hover:border-zinc-700 relative"
            >
              {topic.trending && (
          ...
          <div className="grid grid-cols-1 gap-6">
            {getFilteredTopics().map((topic) => (
              <div
                key={topic.id}
                onClick={() => handleTopicSelect(topic)}
                className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 transition-all duration-500 cursor-pointer hover:scale-[1.02] hover:border-zinc-700 relative"
              >
                {topic.trending && (
