        ...
        <div className={`absolute top-0 left-0 h-full w-80 bg-zinc-950 border-r border-zinc-800 flex flex-col transform transition-transform duration-300 z-10 ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <nav className="flex-1 py-4">
            <div className="space-y-1 px-3">
              ...
              <Link href="/community-topics" className="flex items-start gap-4 p-3 text-white bg-zinc-900/50 rounded-xl cursor-pointer transition-all hover:bg-zinc-900 group">
              ...
              <Link href="/chat-history" className="flex items-start gap-4 p-3 text-zinc-400 hover:text-white rounded-xl cursor-pointer transition-all hover:bg-zinc-900 group">
                <svg className="mt-0.5 group-hover:text-green-500 transition-colors" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
