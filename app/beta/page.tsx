          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-12 md:items-center">
              ...
              <div className="text-center mb-8 md:text-left md:mb-0 md:order-1">
                <div className="inline-block mb-4 px-4 py-2 rounded-full" style={{ backgroundColor: '#00b248', color: '#FFFFFF' }}>
                  <span className="text-sm font-bold">BETA TESTING</span>
                </div>
                <p className="text-base md:text-lg text-gray-600 mb-4">
                  Build on court confidence
                </p>
                <h1 className="text-[2rem] md:text-6xl font-bold leading-tight mb-4 text-black capitalize">
                ...
                <a
                  href="https://www.mycheatcode.ai"
                  className="inline-flex px-12 py-4 rounded-full text-xl font-bold transition-all hover:scale-105 items-center gap-2 shadow-xl"
            ...
            {[
              {
                ...
                answer: "We're currently in beta testing. Sign up now to get early access and special pricing for beta testers."
              },
              {
      ...
      <section className="py-32 px-4" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8">
            Join our beta testing program and help shape the future of mental performance coaching
          </p>
          <a
            href="https://www.mycheatcode.ai"
            className="inline-flex px-16 py-5 rounded-full text-2xl font-bold transition-all hover:scale-105 items-center gap-3 shadow-2xl"
            style={{ backgroundColor: '#00b248', color: '#FFFFFF' }}
          >
            SIGN UP NOW
