  ...
  return (
    <div className="min-h-screen font-sans" style={{ backgroundColor: '#000000', color: '#ffffff' }}>
      ...
      <div className="hidden lg:flex min-h-screen relative">
        ...
        {/* Sidebar Navigation */}
        <div className={`absolute top-0 left-0 h-full w-80 border-r flex flex-col transform transition-transform duration-300 z-10 ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`} style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--card-border)' }}>
          <div className="pt-20"></div>
