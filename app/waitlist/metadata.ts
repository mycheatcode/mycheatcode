...
export const metadata: Metadata = {
  title: 'Join the Beta | MyCheatCode.AI - Mental Performance Coach for Basketball',
  ...
  openGraph: {
    ...
    title: 'MyCheatCode.AI - Mental Performance Coach for Basketball Players',
    ...
    siteName: 'MyCheatCode.AI',
    images: [
      {
        url: 'https://mycheatcode.ai/waitlist-media/hero.png',
        width: 1920,
        height: 1080,
        alt: 'MyCheatCode.AI Dashboard - Mental Performance Tracking',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'MyCheatCode.AI - Mental Performance Coach for Basketball',
