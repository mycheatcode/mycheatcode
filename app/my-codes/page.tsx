    ...
    <div className="min-h-screen font-sans" style={{ color: 'var(--text-primary)' }}>
      ...
      <div className="lg:hidden min-h-screen relative flex flex-col">
        ...
        <div className="p-4 border-b" style={{ borderColor: '#2a2a2a' }}>
          ...
          {/* Page Title */}
          <div className="text-[1.8em] font-bold mb-2" style={{ color: '#ffffff' }}>My Cheat Codes</div>
          <div className="text-sm leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>Your vault of mental performance cheat codes</div>
