...
export default function MyCodesPage() {
  ...
  const [cheatCodes, setCheatCodes] = useState<CheatCode[]>([
    ...
    },
    {
      ...
      summary: "Set boundaries: 'I appreciate your support, but I need space to process games on my own.' Have a post-game routine that gives you time before discussing performance.",
      topicId: 4
    },
    {
      id: 7,
      ...
      sessionsCompleted: 7,
      summary: "Be the first to celebrate teammates' success and the first to encourage after mistakes. Ask teammates about their lives outside basketball. Lead by example in effort and attitude.",
      topicId: 7
    },
    {
      id: 8,
      ...
      sessionsCompleted: 4,
      summary: "After each game, write down 3 things you did well and 1 thing to improve. Focus on effort and decision-making, not just results. This helps maintain perspective and growth mindset.",
      topicId: 9
    },
    {
      id: 9,
      title: "Dealing with Bad Calls",
      category: "In-Game",
      power: 40,
      streak: 1,
      streakType: 'fire',
      ...
      sessionsCompleted: 3,
      summary: "Control what you can control. Channel frustration into defensive intensity or hustle plays. Use the phrase 'Next play' to reset mentally. Bad calls happen to everyone.",
      topicId: 10
    },
    {
      id: 10,
      ...
      summary: "Spend 10 minutes before games visualizing successful plays in vivid detail. See yourself making shots, making good passes, and playing strong defense. Feel the emotions of success.",
      topicId: 1
    },
    {
      id: 11,
      title: "Dealing with Bench Time",
      category: "In-Game",
      power: 30,
      streak: 0,
      streakType: 'sleep',
      ...
      sessionsCompleted: 2,
      summary: "Stay engaged even when not playing. Cheer for teammates, study the game, and be ready when called upon. Your attitude on the bench reflects your character.",
      topicId: 8,
      archived: true
    }
  ]);
