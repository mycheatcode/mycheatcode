    ...
    const loadProgress = async () => {
      ...
      if (user) {
        ...
        if (isOnboardingComplete) {
          ...
          // Show tutorial AFTER momentum animation completes
          // Animation timing: 500ms delay + 1500ms counting + 1000ms hold = 3000ms
          // Add 500ms buffer = 3500ms total
          setTimeout(() => {
            console.log('✅ Showing home page tutorials NOW (after momentum animation)');
            setShowOnboardingTutorials(true);
            router.replace('/', { scroll: false });
          }, 3500); // 3.5 seconds - lets momentum animation fully complete
        }
