...
const userProgression = rawUserProg ? JSON.parse(rawUserProg) : null;
  ...
  // Data polygon - the focus of the chart
  const renderDataPolygon = (centerX: number, centerY: number, maxRadius: number) => {
    ...
    return (
      <g>
        {/* Data polygon with semi-transparent white fill and green stroke */}
        <polygon
    ...
    return (
      <g className={animateClass}>
        ...
        <g mask={`url(#${maskId})`}>
          ...
          <circle cx={centerX} cy={centerY} r="45" fill="rgba(239, 68, 68, 0.8)"/>

          {/* Orange ring - appears at 25% average power, to second divider */}
          {powerPercentage >= 25 && (
            <circle cx={centerX} cy={centerY} r="65" fill="rgba(249, 115, 22, 0.8)"/>
          )}

          {/* Yellow ring - appears at 50% average power, to third divider */}
          {powerPercentage >= 50 && (
            <circle cx={centerX} cy={centerY} r="85" fill="rgba(250, 204, 21, 0.8)"/>
          )}

          {/* Green ring - appears at 75% average power, to fourth divider */}
          {powerPercentage >= 75 && (
            <circle cx={centerX} cy={centerY} r="105" fill="rgba(34, 197, 94, 0.8)"/>
          )}

          {/* Limitless ring - appears at 100% average power, to outer edge */}
          {powerPercentage >= 100 && (
            <circle cx={centerX} cy={centerY} r="125" fill="rgba(34, 197, 94, 0.8)"/>
          )}
        ...
        <div className="flex-1 flex flex-col p-4 pt-8 overflow-visible">
            ...
            <div className="bg-zinc-900/60 border border-zinc-800/60 rounded-2xl px-3 py-2.5 backdrop-blur-sm">
              <div className="flex items-center gap-2.5">
                <div className="flex items-center gap-1.5 group cursor-default">
                  <div className="flex items-center justify-center w-5 h-3 rounded-full border" style={{backgroundColor: 'rgba(255,255,255,0.06)', borderColor: 'rgba(255,255,255,0.1)'}}>
          ...
          <div className="flex-1 flex items-center justify-center overflow-visible">
            <svg width="min(340px, 85vw)" height="min(340px, 85vw)" viewBox="0 0 360 320" className="radar-svg radar-svg-mobile" style={{overflow: 'visible', filter: 'drop-shadow(0 0 20px rgba(255, 255, 255, 0.1)) drop-shadow(0 0 40px rgba(255, 255, 255, 0.05))'}}>
              ...
              <circle cx="180" cy="160" r="125" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="2"/>
              <circle cx="180" cy="160" r="105" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              <circle cx="180" cy="160" r="85" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              <circle cx="180" cy="160" r="65" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              <circle cx="180" cy="160" r="45" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              ...
              <g>
                {/* PRE-GAME */}
                <text x="280" y="18" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11" fontWeight="600" letterSpacing="1.2">PRE-GAME</text>
                ...
                {/* IN-GAME */}
                <text x="350" y="162" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11" fontWeight="600" letterSpacing="1.2">IN-GAME</text>
                ...
                {/* POST-GAME */}
                <text x="230" y="317" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11" fontWeight="600" letterSpacing="1.2">POST-GAME</text>
                ...
                {/* OFF-COURT */}
                <text x="6" y="180" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11" fontWeight="600" letterSpacing="1.2">OFF-COURT</text>
                ...
                {/* LOCKER ROOM */}
                <text x="55" y="18" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11" fontWeight="600" letterSpacing="1.2">LOCKER ROOM</text>
        ...
        <div className="flex-1 flex p-6 pt-20 min-h-screen relative">
            ...
            <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-2xl p-6 pr-12 backdrop-blur-sm relative">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4 group cursor-default">
                  <div className="flex items-center justify-center w-7 h-4 rounded-full border" style={{backgroundColor: 'rgba(255,255,255,0.06)', borderColor: 'rgba(255,255,255,0.1)'}}>
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <svg width="650" height="650" viewBox="0 0 480 440" className="radar-svg radar-svg-desktop" style={{overflow: 'visible', filter: 'drop-shadow(0 0 30px rgba(255, 255, 255, 0.1)) drop-shadow(0 0 60px rgba(255, 255, 255, 0.05))'}}>
              ...
              <circle cx="240" cy="220" r="125" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="2"/>
              <circle cx="240" cy="220" r="105" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              <circle cx="240" cy="220" r="85" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              <circle cx="240" cy="220" r="65" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              <circle cx="240" cy="220" r="45" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
              ...
              <g>
                {/* PRE-GAME */}
                <text x="350" y="78" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="13" fontWeight="600" letterSpacing="1.4">PRE-GAME</text>
                {getGreenHold('Pre-Game').hasActiveHold && (
                  <g>
                ...
                {/* IN-GAME */}
                <text x="410" y="222" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="13" fontWeight="600" letterSpacing="1.4">IN-GAME</text>
                {getGreenHold('In-Game').hasActiveHold && (
                  <g>
                ...
                {/* POST-GAME */}
                <text x="300" y="382" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="13" fontWeight="600" letterSpacing="1.4">POST-GAME</text>
                {getGreenHold('Post-Game').hasActiveHold && (
                  <g>
                ...
                {/* OFF-COURT */}
                <text x="62" y="240" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="13" fontWeight="600" letterSpacing="1.4">OFF-COURT</text>
                {getGreenHold('Off Court').hasActiveHold && (
                  <g>
                ...
                {/* LOCKER ROOM */}
                <text x="105" y="78" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="13" fontWeight="600" letterSpacing="1.4">LOCKER ROOM</text>
                {getGreenHold('Locker Room').hasActiveHold && (
                  <g>
