...
export default function Home() {
  ...
  return (
    <div className="h-screen font-sans relative overflow-hidden flex flex-col" style={{ color: 'var(--text-primary)', backgroundColor: '#000000' }}>
      ...
      {/* Main Content */}
      <div className="flex flex-col items-center px-4 pt-16 pb-6 relative z-10 max-w-[430px] lg:max-w-[600px] mx-auto w-full" style={{ minHeight: '100vh' }}>
        {/* Header Message */}
        ...
        <div className="flex flex-col items-center justify-center flex-1 -mt-4">
          ...
          {/* Progress Visualizer */}
          <div className="w-[min(340px,72vw)] aspect-square -my-8 relative overflow-visible">
            <ProgressCircles
              theme="dark"
