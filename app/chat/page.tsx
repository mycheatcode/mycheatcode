  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans">
      ...
      <div className="hidden lg:flex min-h-screen relative">
        ...
        <div className={`fixed top-0 left-0 h-full w-64 bg-black border-r border-zinc-800 flex flex-col transform transition-transform duration-300 z-10 ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
